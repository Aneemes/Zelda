...
class Level:
    ...
    def create_map(self):
        ...
        layouts = {
            ...
            'object' : import_csv_layout(r'F:/Projects/Zelda/map/map_Objects.csv')
        }
        graphics = {
            'grass' : import_folder(r'F:/Projects/Zelda/graphics/Grass'),
            'object' : import_folder(r'F:/Projects/Zelda/graphics/objects')
        }
...
class YSortCameraGroup(pygame.sprite.Group):
    def __init__(self):
        ...
        self.floor_surf = pygame.image.load(
            r'F:/Projects/Zelda/graphics/tilemap/ground.png').convert()
